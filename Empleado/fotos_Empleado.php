<?php 
include('../cliente/Backend/conexion.php');
		...
		<div class="container-fluid" style="background-color:#ffffff">
			...
			<div class="row">
				<div class="col-lg-3">
					...
					<form action="../cliente/Backend/subir.php" method="post" enctype="multipart/form-data">
				...
				<div class="col-lg-9">
					<h1 class="text-primary text-center">FOTOGRAFÍAS</h1>
					<hr>
					<div class="card-columns">
					<?php foreach($resultado as $row){ ?>
					<div class="card">
							<img src="../cliente/Backend/imagenes/<?php echo $row['imagen']; ?>" class="card-img-top" alt="...">
						<div class="card-body">
								<h5 class="card-title">
