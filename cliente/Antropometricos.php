...
<html>
	...
	<body>
		...
		<div class="container" style="text-align: center;padding: 40px; background-color:#a0d3e6">
			<h5 class="modal-title" id="exampleModalLabel">DATOS ANTROPOMÉTRICOS</h5>

			<form class="form-horizontal" name="calc" role="form" method="post" action="../servidor/Antropologicos.php">
				<div class="row g-3">
					...
					<div class="col">
						<label for="exampleInputEmail1">Altura(m):</label>
				...
				<div class="row g-3">
					<div class="col">
					<input class="boton"type="button"  name="" value="Calcular" onclick="calcular_imc()"/>
					</div>
					</div>
					<br>
					<div class="row g-3">
   ...
   <br><br/>     
			...
			<script>
				function calcular_imc(){
                    var peso=document.calc.peso.value;
                    var altura=document.calc.altura.value;
                    var result=Math.round((peso/Math.pow(altura, 2))*100)/100;
