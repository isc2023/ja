...
<html>
	...
	<body>
		...
		<div class="container" style="text-align: center;padding: 40px; background-color:#a0d3e6">
			...
			<form class="form-horizontal" role="form" method="post" action="../servidor/AntropologicosClie.php">
				<div class="row g-3">
					

					<div class="col">
						<label for="exampleInputEmail1">Altuta(m):</label>
						<input type="text" class="form-control" id="alt" name="alt">
					</div>
					<div class="col">
						<label for="exampleInputEmail1">Peso(kg):</label>
						<input type="text" class="form-control" id="peso" placeholder="Por ejemplo: 50 kg" name="peso">
					</div>
				</div>
				<br>
